# -*- coding: utf-8 -*-
from mauritsbobtemplates import base
...
def test_read_bobtemplate_ini(tmpdir):
    configurator = Configurator(
        template="mauritsbobtemplates:addon", target_directory="collective.todo"
    )
...
"""
    ...
    configurator = Configurator(
        template="mauritsbobtemplates:addon", target_directory=target_dir
    )
    base.read_bobtemplates_ini(configurator)
...
"""
    ...
    with open(os.path.join(target_dir + "/bobtemplate.cfg"), "w") as f:
        f.write(template)
    configurator = Configurator(
        template="mauritsbobtemplates:addon",
...
def test_post_plone_version():
    configurator = Configurator(
        template="mauritsbobtemplates:addon", target_directory="collective.foo"
    )
