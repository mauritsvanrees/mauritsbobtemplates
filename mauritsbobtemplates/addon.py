from mauritsbobtemplates.base import git_commit
from mauritsbobtemplates.base import git_init
from mauritsbobtemplates.base import make_path
from mauritsbobtemplates.utils import run_black
from mauritsbobtemplates.utils import run_isort
...
def pre_render(configurator):
    ...
    # TODO: refactor this to use base_prepare_renderer, like all sub template do
